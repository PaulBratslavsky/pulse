 ...
 */
export type TQueueFilterOverrides = Omit<TQueueSearchParams, "page"> & {
  page?: number;
};

// ── Unions ──────────────────────────────────────────────────────────────────

export type TOutcomeResult =
  | "resolved"
  | "positive-turn"
  | "no-reaction"
  | "escalated";
export type TMentionStatus =
  | "unanswered"
  | "claimed"
  | "answered"
  | "resolved"
