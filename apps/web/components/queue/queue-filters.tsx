  ...
  return (
    <div className="mb-4 space-y-1.5 text-sm">
      ...
      <FilterRow label="flags">
        ...
        <FilterPill
          href={filterUrl({
            awaiting: params.awaiting ? undefined : "1",
            page: 0,
          })}
        ...
        <FilterPill
          href={filterUrl({
            topics: params.topics === "none" ? undefined : "none",
            page: 0,
          })}
        ...
        <FilterPill
          href={filterUrl({
            quality: params.quality === "spam" ? undefined : "spam",
            page: 0,
          })}
