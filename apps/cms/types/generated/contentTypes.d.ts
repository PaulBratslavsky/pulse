...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'System-written audit trail entry for a mention workflow transition';
...
export interface ApiChannelChannel extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Social platform mentions come from';
    displayName: 'Channel';
    pluralName: 'channels';
...
export interface ApiDeadLetterDeadLetter extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Webhook payload that failed validation \u2014 kept raw, replayable, never dropped';
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Release, launch, or incident that annotates the sentiment timeline';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
  ...
  attributes: {
    ...
    kind: Schema.Attribute.Enumeration<['release', 'launch', 'incident']> &
      Schema.Attribute.DefaultTo<'release'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMentionMention extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A social mention ingested from the mention source';
    displayName: 'Mention';
    pluralName: 'mentions';
  ...
  attributes: {
    acknowledgeReason: Schema.Attribute.Enumeration<
      ['competitor', 'not-relevant', 'watching', 'own-post']
    >;
...
export interface ApiResponseResponse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'What was replied to a mention, by whom, and how it landed';
...
export interface ApiTopicTopic extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Theme mentions cluster into; machine-created, admin-curated';
    displayName: 'Topic';
    pluralName: 'topics';
    singularName: 'topic';
  };
  ...
  attributes: {
    ...
    kind: Schema.Attribute.Enumeration<
      ['feature', 'bug', 'docs', 'competitor', 'other']
    > &
      Schema.Attribute.DefaultTo<'other'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::topic.topic'> &
      Schema.Attribute.Private;
    mentions: Schema.Attribute.Relation<'manyToMany', 'api::mention.mention'>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
