...
const AUTHENTICATED_ACTIONS = [
  ...
  'api::muted-topic.muted-topic.find',
  'api::muted-topic.muted-topic.mute',
  'api::muted-topic.muted-topic.unmute',
  'api::muted-topic.muted-topic.rescan',
  'api::muted-topic.muted-topic.suggestions',
